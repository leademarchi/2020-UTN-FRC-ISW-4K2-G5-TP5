...
function LoQueSeaController($scope,$http){
    ...
    $scope.horaProgramada = null;
    $scope.fechaProgramada = null;
    $scope.pedidoEnviado = false;
    var fechaA = new Date();
    $scope.fechaActual =  fechaA.getFullYear()+"-"+(fechaA.getMonth()+1)+"-"+fechaA.getDate();
    ...
    function obtenerCoordenadasComercio() {
        ...
        ',+cordoba'+
        '&key=AIzaSyBXyvj1gciImloP9kRCE-dBU-YOtqYn-zI')
